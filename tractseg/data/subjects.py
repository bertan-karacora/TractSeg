...
def all_subjects_biobank_20k():
    base_path = join(config.DATA_PATH, "biobank_preproc")
    with open(join(base_path, "biobank_all_subjects_with_DWI_shuffled_xtract_complete.txt"), "r") as f:
        lines = f.read().splitlines()
    return lines


all_subjects_biobank_10 = ["1000013", "1000024", "1000036", "1000048", "1000055", "1000067", "1000072", "1000080", "1000099", "1000106"]

subjects_90g_incomplete = ["601127", "620434", "644044", "715041", "749361", "753251", "792766", "872764", "901038", "951457", "979984", "814649"]
