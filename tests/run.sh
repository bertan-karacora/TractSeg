...
TractSeg -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/BS_PP/tractseg_output \
    --single_orientation \
    --test
...
# Bundle specific postprocessing
TractSeg -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/no_PP/tractseg_output \
    --single_orientation \
    --no_postprocess \
    --test
...
# Get probabilities
TractSeg -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/Probs/tractseg_output \
    --single_orientation \
    --test \
    --get_probabilities
...
# Get uncertainties
TractSeg -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/Uncert/tractseg_output \
    --single_orientation \
    --test \
    --uncertainty
...
TractSeg -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/DM/tractseg_output \
    --single_orientation \
    --test \
...
# Bundles
TractSeg -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/tractseg_output \
    --single_orientation
...
# Track
Tracking -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/tractseg_output \
    --nr_fibers 10000 \
    --test 3

# Tractometry
Tractometry -i resources/examples/tractseg_output/TOM_trackings \
    -o resources/examples/Tractometry.csv \
    -e resources/examples/tractseg_output/endings_segmentations/ \
    -s tests/reference_files/FA.nii.gz \
    --test 3
...
Tractometry -i tractometry_toy_example/TOM_trackings \
    -o tractometry_toy_example/Tractometry.csv \
    -e tractometry_toy_example/endings_segmentations/ \
    -s tractometry_toy_example/toy_FA.nii.gz \
    --test 2 \
    --nr_points 10 \
    --tracking_format tck
...
plot_tractometry_results -i tests/reference_files/subjects_group.txt \
    -o resources/examples/tractometry_result_group.png \
    --mc \
    --save_csv
...
plot_tractometry_results -i tests/reference_files/subjects_correlation.txt \
    -o resources/examples/tractometry_result_correlation.png \
    --mc \
    --save_csv
...
# Bundles SR noPP
TractSeg -i tests/reference_files/peaks.nii.gz \
    -o resources/examples/SR_noPP/tractseg_output \
    --single_orientation \
    --super_resolution \
    --no_postprocess
